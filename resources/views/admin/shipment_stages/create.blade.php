                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="applies_to" name="applies_to" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="both" {{ old('applies_to', 'both') === 'both' ? 'selected' : '' }}>كلاهما</option>
                                <option value="sea" {{ old('applies_to') === 'sea' ? 'selected' : '' }}>بحري</option>
                                <option value="land" {{ old('applies_to') === 'land' ? 'selected' : '' }}>بري</option>
                            </select>
