                            ...
                            <div class="mt-2 space-y-2">
                                @foreach($stages as $stage)
                                    <label class="inline-flex items-center ml-4">
                                        <input type="checkbox" name="stages[]" value="{{ $stage->id }}" {{ in_array($stage->id, old('stages', [])) ? 'checked' : '' }} class="rounded border-slate-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
