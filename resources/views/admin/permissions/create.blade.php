<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">إضافة صلاحية</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.permissions.store') }}" class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
                @csrf
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('admin.permissions.index') }}" class="px-4 py-2 border rounded-md text-gray-700">إلغاء</a>
