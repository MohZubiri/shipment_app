    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('تعديل خط ملاحي') }}: {{ $shippingLine->name }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                <div class="p-8 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.shipping-lines.update', $shippingLine) }}"
                        class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name', $shippingLine->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="company_name" class="block w-full" type="text" name="company_name"
                                    :value="old('company_name', $shippingLine->company_name)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="code" class="block w-full" type="text" name="code" :value="old('code', $shippingLine->code)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="time" class="block w-full" type="number" name="time"
                                    :value="old('time', $shippingLine->time)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block w-full" type="text" name="phone"
                                    :value="old('phone', $shippingLine->phone)" />
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <x-text-input id="contact_email" class="block w-full" type="email" name="contact_email"
                                    :value="old('contact_email', $shippingLine->contact_email)" />
