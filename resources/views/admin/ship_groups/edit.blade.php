    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('تعديل مجموعة سفن') }}: {{ $shipGroup->name }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                <div class="p-8 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.ship-groups.update', $shipGroup) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name', $shipGroup->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="groupid" class="block w-full" type="text" name="groupid"
                                    :value="old('groupid', $shipGroup->groupid)" />
