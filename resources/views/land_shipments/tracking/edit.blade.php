    ...
    <div class="py-12">
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="p-6 bg-white border shadow-sm sm:rounded-xl border-slate-100">
                <form method="POST" action="{{ route('road-shipments.tracking.update', [$landShipping, $tracking]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div id="container-fields" class="hidden space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="container_count" name="container_count" min="1" class="block mt-1 w-full rounded-lg shadow-sm border-slate-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('container_count', $tracking->container_count) }}">
