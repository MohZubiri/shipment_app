            ...
            <form method="POST" action="{{ route('local-shipments.store') }}"
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <input id="serial_number" name="serial_number" type="number" value="{{ old('serial_number') }}"
                    ...
                    <div>
                        ...
                        <input id="vehicle_plate_number" name="vehicle_plate_number" type="text" value="{{ old('vehicle_plate_number') }}"
                    ...
                    <div>
                        ...
                        <input id="arrival_time_from_branch" name="arrival_time_from_branch" type="time" value="{{ old('arrival_time_from_branch') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700" for="departure_time_to_branch">وقت المغادرة إلى الفرع</label>
                        <input id="departure_time_to_branch" name="departure_time_to_branch" type="time" value="{{ old('departure_time_to_branch') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700" for="arrival_date_from_branch">تاريخ الوصول من الفرع</label>
                        <input id="arrival_date_from_branch" name="arrival_date_from_branch" type="date" value="{{ old('arrival_date_from_branch') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div>
                    ...
                    <div class="lg:col-span-3">
                        ...
                        <input id="cargo_description" name="cargo_description" type="text" value="{{ old('cargo_description') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700" for="vehicle_number">رقم السيارة</label>
                        <input id="vehicle_number" name="vehicle_number" type="text" value="{{ old('vehicle_number') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="exit_date_from_manufacture" name="exit_date_from_manufacture" type="date" value="{{ old('exit_date_from_manufacture') }}"
                            class="mt-2 w-full rounded-md border-slate-300">
                    </div>
                    <div class="lg:col-span-3">
