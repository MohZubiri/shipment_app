<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-900 leading-tight">إضافة بيان جمركي</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('customs.store') }}" class="bg-white shadow-sm sm:rounded-xl p-6 space-y-6 border border-slate-100">
                @csrf
                ...
                <div>
                    ...
                    <input id="datano" name="datano" type="number" value="{{ old('datano') }}" required class="mt-2 w-full rounded-md border-slate-300">
                </div>
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('customs.index') }}" class="px-4 py-2 border rounded-md text-slate-700">إلغاء</a>
